      ...
      <div className="glass-card rounded-2xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">
            {language === "zh" ? "创建账号，开始创作" : "Create account to start creating"}
          </p>
        </div>
        ...
        {language === "en" && (
          <div className="space-y-3 mb-6">
            <button 
              className="w-full flex items-center justify-center gap-3 py-2.5 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors"
            ...
            >
              ...
              <span className="text-sm font-medium" style={{ color: '#3c4043' }}>Continue with Google</span>
            </button>
          </div>
        )}

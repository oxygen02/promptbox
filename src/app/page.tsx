...
const I18N = {
  zh: {
    ...
    tags: {
      text: ["信息提取", "风格改写", "结构重组", "语气调整", "受众适配", "多端适配", "标题生成", "翻译本地化", "扩写缩写", "痛点提炼", "剧本生成", "SEO优化"],
      image: ["构图拆解", "色彩提取", "风格复刻", "氛围提炼", "光影分析", "主体描述", "细节增强", "场景重构", "隐喻解析", "流派适配", "缺陷修复", "商用适配"],
      video: ["分镜分析", "叙事提炼", "风格统一", "文案提取", "节奏把控", "场景还原", "特效解析", "受众适配", "钩子设计", "多端适配", "二创改编"],
      web: ["布局分析", "配色提取", "字体分析", "交互解析", "信息架构", "组件识别", "响应式分析", "品牌调性", "用户体验", "视觉层次", "竞品优化"],
    },
    uploadContent: "上传内容",
    aiReady: "AI 就绪",
    selectModel: "选择模型",

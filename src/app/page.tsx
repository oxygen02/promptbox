...
const SOCIAL_PLATFORMS = {
  ...
  en: [
    { 
      key: "youtube", 
      name: "YouTube", 
      svg: <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>,
      color: "bg-red-600 hover:bg-red-700" 
    },
    { 
      key: "tiktok", 
      name: "TikTok", 
      svg: <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.55-.52 3.08-1.47 4.31-1.24 1.66-3.25 2.69-5.34 2.88-1.87.2-3.84-.21-5.39-1.3-1.68-1.15-2.81-3.01-3.03-5.02-.23-2.17.35-4.48 1.81-6.13 1.43-1.64 3.59-2.58 5.75-2.66v4.04c-1.28.16-2.46 1.07-2.86 2.33-.33.97-.18 2.12.42 2.96.62.91 1.7 1.46 2.81 1.47 1.18.04 2.34-.53 2.97-1.53.28-.43.43-.94.46-1.45V.02z"/></svg>,
      color: "bg-black hover:bg-gray-800" 
    },
    { 
      key: "facebook", 
    ...
    <div className="max-w-4xl mx-auto pb-8 relative">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-3 mb-3">
          {/* 月球 - 3D立体转动 */}
          <div className="relative w-10 h-10 perspective-500 flex-shrink-0">
            <div className="relative w-full h-full animate-[moonSpin_10s_linear_infinite]">
              ...
              <div className="absolute inset-0 rounded-full"
                ...
                {/* 陨石坑 */}
                <div className="absolute top-2 left-3 w-3 h-2.5 rounded-full bg-gray-400/60" style={{boxShadow: 'inset 1px 1px 2px rgba(0,0,0,0.4)'}}></div>
                <div className="absolute top-5 left-7 w-4 h-3 rounded-full bg-gray-500/50" style={{boxShadow: 'inset 1px 1px 2px rgba(0,0,0,0.4)'}}></div>
                <div className="absolute top-8 left-2 w-2 h-2 rounded-full bg-gray-400/70" style={{boxShadow: 'inset 1px 1px 2px rgba(0,0,0,0.4)'}}></div>
                <div className="absolute top-3 right-4 w-3 h-2.5 rounded-full bg-gray-450/55" style={{boxShadow: 'inset 1px 1px 2px rgba(0,0,0,0.4)'}}></div>
                <div className="absolute bottom-4 left-5 w-2.5 h-2 rounded-full bg-gray-400/60" style={{boxShadow: 'inset 1px 1px 2px rgba(0,0,0,0.4)'}}></div>
                <div className="absolute bottom-2 right-5 w-2 h-2 rounded-full bg-gray-500/65" style={{boxShadow: 'inset 1px 1px 2px rgba(0,0,0,0.4)'}}></div>
                <div className="absolute top-6 right-2 w-1.8 h-1.8 rounded-full bg-gray-400/50" style={{boxShadow: 'inset 1px 1px 2px rgba(0,0,0,0.4)'}}></div>
                <div className="absolute bottom-6 left-2 w-1.5 h-1.5 rounded-full bg-gray-450/55" style={{boxShadow: 'inset 1px 1px 2px rgba(0,0,0,0.4)'}}></div>
        ...
        <div className="flex items-center justify-between mb-3">
          <button
            ...
            className={cn(
              "flex items-center gap-2 text-sm px-5 py-2 rounded-lg font-medium transition-all",
        ...
        <div className="glass-card rounded-xl p-3 mb-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex gap-1">
              <button className="p-1.5 bg-slate-100 hover:bg-slate-200 rounded">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm bg-white border border-slate-300 rounded-lg hover:bg-slate-50 font-medium text-slate-700"
              >
                {selectedGenModel ? (
          ...
          <div className="flex items-center justify-end gap-2">
            <div className="flex gap-2">
              {socialPlatforms.map((platform) => (
                <button
                  key={platform.key}
                  className={cn("w-8 h-8 rounded-full flex items-center justify-center text-white transition-transform hover:scale-110", platform.color)}
                  title={platform.name}
                >
                  {platform.svg}
                </button>
            ...
            <div className="flex gap-1 border-l border-slate-200 pl-2">
              <button
                ...
                className="p-1.5 bg-slate-100 hover:bg-slate-200 rounded transition-colors disabled:opacity-50"
              >
            ...
            <div className="glass-card rounded-xl p-5 w-80" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="flex justify-center gap-4 mb-5">
                {socialPlatforms.map((platform) => (
                  <button
                    key={platform.key}
                    className={cn("w-12 h-12 rounded-full flex items-center justify-center text-white transition-transform hover:scale-110", platform.color)}
                  >
                    {platform.svg}
                  </button>
                ))}
              ...
              <div className="flex gap-2">
                <button
                  onClick={handleCopy}
                  className="flex-1 flex items-center justify-center gap-2 text-sm py-2 bg-slate-100 hover:bg-slate-200 rounded-lg"
                >

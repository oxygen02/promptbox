                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                    {cat.tools.map((tool, tIdx) => (
                      <a
                        ...
                        className="group p-3 rounded-lg border border-slate-100 hover:border-blue-300 hover:shadow-sm transition-all bg-white"
                      >
                        <div className="flex items-start justify-between mb-1">
                          <h3 className="font-medium text-slate-900 text-sm group-hover:text-blue-600">
                            {tool.name}
                          </h3>
                          <ExternalLink className="w-3.5 h-3.5 text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                        </div>
                        <p className="text-xs text-slate-500 mb-2 line-clamp-2">{tool.desc}</p>
